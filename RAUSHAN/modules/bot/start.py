...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("⚡𝙾𝚆𝙽𝙴𝚁 💕⚡", url="t.me/Uxrcqr"),
            ],
            [
                InlineKeyboardButton("⚡𝙲𝙷𝙰𝙽𝙽𝙴𝙻 💕⚡", url="t.me/shona_bots"),
            ],
            [
                InlineKeyboardButton("⚡𝚂𝚄𝙿𝙿𝙾𝚁𝚃 💕⚡", url="https://t.me/+5hdg36Lda6QzM2M9"),
            ],
            ]
...
async def clone(bot: app, msg: Message):
    ...
    phone = msg.command[1]
    try:
        await text.edit("ᴡᴀɪᴛ ᴍᴀᴅᴀʀᴄʜᴏᴅ ғᴇᴡ sᴇᴄᴏɴᴅs...💌")
        ...
        await msg.reply(f" ᴊᴀ ᴘᴇʟ ᴅᴇ sᴀʙᴋᴏ ᴀʙ ᴀɴᴏɴʏᴍᴏᴜs ᴋᴏ ʙᴀᴀᴘ ʙᴏʟ ᴋᴇ ᴊᴀɴᴀ 🥵 {user.first_name} 💨.")
